class CfgMovesMaleSdr: CfgMovesBasic
{
	class States
	{
		...
		{
			file = "\fr4_starwars_animations\anim\cutscenes\rgr_firme.rtm";
			speed = 1e-10;
			ConnectTo[] = {};
			InterpolateTo[] = {"AmovPercMstpSnonWnonDnon",0.01};
		};
		class fr4_fusilsuelo: CutSceneAnimationBaseConPistola
		{
			file = "\fr4_starwars_animations\anim\cutscenes\fr4_fusil_suelo.rtm";
			speed = 1e-10;
			actions = "NoActions";
			ConnectTo[] = {"AmovPercMstpSnonWnonDnon",0.01};
			InterpolateTo[] = {};
		...
		{
			file = "\fr4_starwars_animations\anim\cutscenes\rgr_silencio.rtm";
			speed = 1e-10;
			actions = "NoActions";
			ConnectTo[] = {"AmovPercMstpSnonWnonDnon",0.01};
			InterpolateTo[] = {};
		...
		{
			file = "\fr4_starwars_animations\anim\cutscenes\rgr_choquepunch.rtm";
			speed = 1e-10;
			actions = "NoActions";
			ConnectTo[] = {"AmovPercMstpSnonWnonDnon",0.01};
			InterpolateTo[] = {};
