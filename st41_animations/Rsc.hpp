...
{
	onLoad="[2] call compile preprocessfilelinenumbers gettext (configfile >> 'CfgFunctions' >> 'init');[1201,(_this) select 0,'RscDisplayStart'] call (uinamespace getvariable 'st41_fnc_setRandomBackground');[1202,(_this) select 0,'RscDisplayStart'] call (uinamespace getvariable 'st41_fnc_setRandomBackground');";
	...
	class controls
	{
		...
		class LoadingStart: RscControlsGroup
		{
			...
			class controls
			{
				...
				{
					idc = 1200;
					text = "st41\st41_animations\data\41st_logo.paa";
					x = "0.25 * safezoneW";
					y = "0.3125 * safezoneH";
					w = "0.5 * safezoneW";
					h = "0.25 * safezoneH";
					onLoad = "if (395180 in getDLCs 1) then {(_this select 0) ctrlsettext 'st41\st41_animations\data\41st_logo.paa';};";
				};
			};
		};
	};
...
{
	onLoad="['onload',_this,'RscDisplayLoading'] call (uiNamespace getVariable 'full_mission_load_fnc_load');[654,(_this) select 0,'RscDisplayLoadMission'] call (uinamespace getvariable 'st41_fnc_setRandomBackground');[999,(_this) select 0,'RscDisplayLoadMission'] call (uinamespace getvariable 'st41_fnc_setRandomBackground');[1201,(_this) select 0,'RscDisplayLoadMission'] call (uinamespace getvariable 'st41_fnc_setRandomBackground');call (uiNamespace getVariable 'st41_fnc_stopMusic');uiNamespace setVariable ['st41_vueltaMenu',true];";
	onUnload="[""onUnload"",_this,""RscDisplayLoading""] call (uiNamespace getVariable 'full_mission_load_fnc_load')";
	class controlsBackground
	{
		class CA_Vignette: RscVignette
	...
	class controls
	{
		...
		{
			colorBar[] = {};
			texture = "st41\st41_animations\data\loadingSword.paa";
			x = "safezoneX + 0.6";
			y = "safezoneY - 0.1";
			w = "safezoneW - 0.6";
			idc = 104;
		...
		class LoadingStart: RscControlsGroup
		{
			...
			class controls
			{
				...
				{
					idc = 1200;
					text = "st41\st41_animations\data\41st_logo_big.paa";
					x = "0.25 * safezoneW";
					y = "0.3125 * safezoneH";
					w = "0.5 * safezoneW";
					h = "0.25 * safezoneH";
...
{
	onLoad="['onload',_this,'RscDisplayLoading'] call (uiNamespace getVariable 'full_mission_load_fnc_load');[102,(_this) select 0,'RscDisplayLoading'] call (uinamespace getvariable 'st41_fnc_setRandomBackground')}";
	onUnload="[""onUnload"",_this,""RscDisplayLoading""] call (uiNamespace getVariable 'full_mission_load_fnc_load');uiNamespace setVariable ['st41_vueltaMenu',true]";
...
{
	onLoad="['onload',_this,'RscDisplayNotFreeze'] call (uiNamespace getVariable 'full_mission_load_fnc_load');[102,(_this) select 0,'RscDisplayNotFreeze'] call (uinamespace getvariable 'st41_fnc_setRandomBackground');[1201,(_this) select 0,'RscDisplayNotFreeze'] call (uinamespace getvariable 'st41_fnc_setRandomBackground')";
...
{
	onLoad="['onload',_this,'RscDisplayLoadCustom'] call (uiNamespace getVariable 'full_mission_load_fnc_load');[102,(_this) select 0,'RscDisplayLoadCustom'] call (uinamespace getvariable 'st41_fnc_setRandomBackground')";
...
{
	onLoad = "[""onLoad"",_this,""RscDisplayMain"",'GUI'] call  (uinamespace getvariable 'BIS_fnc_initDisplay');[102,(_this) select 0,'RscDisplayMain'] call (uinamespace getvariable 'st41_fnc_setRandomBackground');";
	...
	onMouseMoving = "if (uiNamespace getVariable 'st41_vueltaMenu') then {'vueltamenu.wav' call (uiNamespace getvariable 'st41_fnc_startMusic');uiNamespace setVariable ['st41_vueltaMenu',false]};";
	class controlsBackground
	{
		class CA_Vignette: RscVignette
		{
	...
	class controls {
		...
		{
			action = "'http://41st.es/' call (uiNamespace getVariable 'st41_fnc_openWebPage')";
			soundClick[] = {};
			soundEnter[] = {};
			text = "st41\st41_animations\data\41st_logo_big.paa";
			tooltip = "41st - Cuerpo de Elite - Visita http://41st.es";
...
class RscTitles
{
	class st41_jetpack_gui {
		idd = -1;
		duration = 1e+010;
		onLoad = "uiNamespace setVariable ['st41_jetpack_gui',_this];((_this select 0) displayCtrl -1) progressSetPosition 1";
		class Controls
		{
			class Progress: RscProgress
			{
				colorBar[] = {};
				texture = "st41\st41_animations\data\progress_bar.paa";
				x = "safezoneX";
	...
	class RscDisplayMainMenuBackground
	{
		...
		scriptPath = "GUI";
		onLoad = "[""onLoad"",_this,""RscDisplayMainMenuBackground"",'GUI'] call 	(uinamespace getvariable 'BIS_fnc_initDisplay');[102,(_this) select 0,'RscDisplayMainMenuBackground'] call (uinamespace getvariable 'st41_fnc_setRandomBackground');";
	...
	class SplashNoise
	{
		onLoad="[2] call compile preprocessfilelinenumbers gettext (configfile >> 'CfgFunctions' >> 'init'); 'introMusic.wav' call (uiNamespace getVariable 'st41_fnc_startMusic');[1,(_this) select 0,'SplashNoise'] call (uinamespace getvariable 'st41_fnc_setRandomBackground')";
		idd = -1;
		movingEnable = 0;
		duration = 11;
		fadein = 2;
...
class CfgWrapperUI
{
	...
	class Cursors
	{
		class Arrow
		{
			texture = "st41\st41_animations\data\cursor.paa";
			width = 32;
			height = 32;
			hotspotX = 0.1875;
			hotspotY = 0.03125;
